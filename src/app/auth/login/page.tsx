        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" color="blue" className="w-full" disabled={isLoading}>
              {isLoading ? (
                <span className="flex items-center gap-2"><Spinner size="sm" /> Вход...</span>
              ) : 'Войти'}
            </Button>
          </form>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button color="light" onClick={() => handleOAuthLogin('google')} className="w-full">
                <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24">
                  ...
                  <path fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93л2.85-2.22.81-.62z"/>
                  <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64л3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07л3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                </svg>
                Google
              </Button>
